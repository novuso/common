...
/**
 * MessageInterface is the interface for a domain message
 *
 * @copyright Copyright (c) 2017, Novuso. <http://novuso.com>
 * @license   http://opensource.org/licenses/MIT The MIT License
 * @author    John Nickell <email@johnnickell.com>
 */
interface MessageInterface extends Arrayable, Comparable, Equatable, JsonSerializable, SerializableInterface
{
    /**

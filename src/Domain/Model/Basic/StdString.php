...
use Novuso\Common\Domain\Model\Api\StringLiteral;
...
/**
 * StdString is a wrapper for a standard ASCII string
 *
 * @copyright Copyright (c) 2016, Novuso. <http://novuso.com>
 * @license   http://opensource.org/licenses/MIT The MIT License
 * @author    John Nickell <email@johnnickell.com>
 */
class StdString extends ValueObject implements StringLiteral
{
    use StringOffsets;

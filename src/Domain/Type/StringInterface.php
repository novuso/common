...
/**
 * StringInterface is the interface for a string wrapper
 *
 * @copyright Copyright (c) 2017, Novuso. <http://novuso.com>
 * @license   http://opensource.org/licenses/MIT The MIT License
 * @author    John Nickell <email@johnnickell.com>
 */
interface StringInterface extends ArrayAccess, Comparable, Countable, IteratorAggregate, ValueInterface
{
    /**
     ...
     *
     * Each string in the list is represented by a StringInterface instance.
     *

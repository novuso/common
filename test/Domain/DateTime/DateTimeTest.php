...
/**
 * @covers \Novuso\Common\Domain\DateTime\DateTime
 */
class DateTimeTest extends UnitTestCase
{
    public function test_that_create_returns_expected_instance()
    {
        ...
        $this->assertSame('2015-06-20T16:30:06[America/Chicago]', $dateTime->toString());
    }
    ...
    {
        $dateTime = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $this->assertSame('16:30:06', $dateTime->time()->toString());
    }
    ...
    {
        $dateTime = DateTime::create(2016, 6, 20, 16, 30, 6, 'America/Chicago');
    ...
    {
        $dateTime = DateTime::create(2015, 11, 20, 16, 30, 6, 'America/Chicago');
    ...
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $dateTime2 = $dateTime1->modify('-2 years');
        $this->assertSame('2013-06-20T16:30:06[America/Chicago]', $dateTime2->toString());
    }
    ...
    public function test_that_modify_does_not_change_original_instance()
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $dateTime2 = $dateTime1->modify('-2 years');
        $this->assertSame('2015-06-20T16:30:06[America/Chicago]', $dateTime1->toString());
    }
    ...
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $dateTime2 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $this->assertSame(0, $dateTime1->compareTo($dateTime2));
    }

    public function test_that_compare_to_returns_one_for_greater_timestamp()
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 7, 'America/Chicago');
        $dateTime2 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
    ...
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $dateTime2 = DateTime::create(2015, 6, 20, 16, 30, 7, 'America/Chicago');
        $this->assertSame(-1, $dateTime1->compareTo($dateTime2));
    }

    public function test_that_compare_to_returns_one_for_greater_timezone_string_compare()
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Los_Angeles');
        $dateTime2 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $this->assertSame(1, $dateTime1->compareTo($dateTime2));
    }
    ...
    {
        $dateTime1 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Chicago');
        $dateTime2 = DateTime::create(2015, 6, 20, 16, 30, 6, 'America/Los_Angeles');
        $this->assertSame(-1, $dateTime1->compareTo($dateTime2));
    }

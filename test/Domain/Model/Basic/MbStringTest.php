...
/**
 * @covers Novuso\Common\Domain\Model\Basic\MbString
 */
class MbStringTest extends UnitTestCase
{
    public function test_that_constructor_takes_string_value()
    {
        $string = new MbString('hello');
    ...
    {
        $string = MbString::create('hello world');
    ...
    {
        $string = MbString::create('foo:bar:baz');
    ...
    {
        $string = MbString::create("\t\tpublic function name();");
    ...
    {
        $string = MbString::create('testStringForConversionMethods');
    ...
    {
        $string = MbString::create('test_string_for_conversion_methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }

    public function test_that_to_camel_case_returns_expected_from_lower_hyphenated()
    {
        $string = MbString::create('test-string-for-conversion-methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }
    ...
    {
        $string  = MbString::create('testAStringTestAStringTestAStringForThis');
    ...
    {
        $string = MbString::create('February 14th, 2007');
    ...
    {
        $string1 = MbString::create('hello world');
        $string2 = MbString::create('hello world');
    ...
    {
        $string1 = MbString::create('hello');
        $string2 = MbString::create('goodbye');
        $this->assertSame(1, $string1->compareTo($string2));
    }

    public function test_that_compare_to_returns_neg_one_for_lesser_value()
    {
        $string1 = MbString::create('goodbye');
        $string2 = MbString::create('hello');
        $this->assertSame(-1, $string1->compareTo($string2));
    }

...
namespace Novuso\Test\Common\Domain\Model\Basic;

use Novuso\Common\Domain\Model\Basic\StdString;
use Novuso\Test\System\TestCase\UnitTestCase;

/**
 * @covers Novuso\Common\Domain\Model\Basic\StdString
 * @covers Novuso\Common\Domain\Model\Basic\StringOffsets
 */
class StdStringTest extends UnitTestCase
{
    ...
    {
        $string = StdString::create('hello');
        $interface = 'Novuso\\System\\Collection\\Api\\IndexedList';
        $this->assertInstanceOf($interface, $string->chars());
    }

    public function test_that_contains_returns_true_for_valid_search()
    {
        $string = StdString::create('hello world');
    ...
    {
        $string = StdString::create('foo:bar:baz');
    ...
    {
        $string = StdString::create("\t\tpublic function name();");
    ...
    {
        $string = StdString::create('testStringForConversionMethods');
    ...
    {
        $string = StdString::create('test_string_for_conversion_methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }

    public function test_that_to_camel_case_returns_expected_from_lower_hyphenated()
    {
        $string = StdString::create('test-string-for-conversion-methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }
    ...
    {
        $string  = StdString::create('testAStringTestAStringTestAStringForThis');
    ...
    {
        $string = StdString::create('February 14th, 2007');
    ...
    {
        $string1 = StdString::create('hello world');
        $string2 = StdString::create('hello world');
    ...
    {
        $string1 = StdString::create('hello');
        $string2 = StdString::create('goodbye');
        $this->assertSame(1, $string1->compareTo($string2));
    }

    public function test_that_compare_to_returns_neg_one_for_lesser_value()
    {
        $string1 = StdString::create('goodbye');
        $string2 = StdString::create('hello');
        $this->assertSame(-1, $string1->compareTo($string2));
    }

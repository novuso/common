...
/**
 * @covers \Novuso\Common\Domain\Type\CString
 * @covers \Novuso\Common\Domain\Type\Traits\StringOffsets
 */
class CStringTest extends UnitTestCase
{
    ...
    {
        $string = CString::create('hello world');
    ...
    {
        $string = CString::create('foo:bar:baz');
    ...
    {
        $string = CString::create("\t\tpublic function name();");
    ...
    {
        $string = CString::create('testStringForConversionMethods');
    ...
    {
        $string = CString::create('test_string_for_conversion_methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }

    public function test_that_to_camel_case_returns_expected_from_lower_hyphenated()
    {
        $string = CString::create('test-string-for-conversion-methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }
    ...
    {
        $string  = CString::create('testAStringTestAStringTestAStringForThis');
    ...
    {
        $string = CString::create('February 14th, 2007');
    ...
    {
        $string1 = CString::create('hello world');
        $string2 = CString::create('hello world');
    ...
    {
        $string1 = CString::create('hello');
        $string2 = CString::create('goodbye');
        $this->assertSame(1, $string1->compareTo($string2));
    }

    public function test_that_compare_to_returns_neg_one_for_lesser_value()
    {
        $string1 = CString::create('goodbye');
        $string2 = CString::create('hello');
        $this->assertSame(-1, $string1->compareTo($string2));
    }

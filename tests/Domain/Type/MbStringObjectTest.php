...
class MbStringObjectTest extends UnitTestCase
{
    ...
    {
        $string = MbStringObject::create('hello');
        $this->assertInstanceOf(Sequence::class, $string->chars());
    }

    public function test_that_contains_returns_true_for_valid_search()
    {
        $string = MbStringObject::create('hello world');
    ...
    {
        $string = MbStringObject::create('world');
    ...
    {
        $string = MbStringObject::create('foo:bar:baz');
    ...
    {
        $string = MbStringObject::create("\t\tpublic function name();");
    ...
    {
        $string = MbStringObject::create('GET');
    ...
    {
        $string = MbStringObject::create('A');
    ...
    {
        $string = MbStringObject::create('testStringForConversionMethods');
    ...
    {
        $string = MbStringObject::create('test_string_for_conversion_methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }

    public function test_that_to_camel_case_returns_expected_from_lower_hyphenated()
    {
        $string = MbStringObject::create('test-string-for-conversion-methods');
        $this->assertSame('testStringForConversionMethods', $string->toCamelCase()->toString());
    }
    ...
    {
        $string  = MbStringObject::create('testAStringTestAStringTestAStringForThis');
    ...
    {
        $string = MbStringObject::create('February 14th, 2007');
    ...
    {
        $string1 = MbStringObject::create('hello world');
        $string2 = MbStringObject::create('hello world');
    ...
    {
        $string1 = MbStringObject::create('hello');
        $string2 = MbStringObject::create('goodbye');
        $this->assertSame(1, $string1->compareTo($string2));
    }

    public function test_that_compare_to_returns_neg_one_for_lesser_value()
    {
        $string1 = MbStringObject::create('goodbye');
        $string2 = MbStringObject::create('hello');
        $this->assertSame(-1, $string1->compareTo($string2));
    }
    ...
    public function test_that_get_throws_exception_for_invalid_index()
    {
        ...
        MbStringObject::create('hello')->get(7);
    }
